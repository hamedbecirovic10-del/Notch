...
struct NotchGeometry {
    ...
    /// Expanded panel size (the drawer that drops down on hover). Tall enough
    /// that its content clears the physical notch height at the top.
    var expandedSize: CGSize {
        CGSize(width: 400, height: 178)
    }
